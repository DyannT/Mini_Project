...
<div class="container">
    <div class="card mt-5">
        ...
        <form method="POST" action="index.php?controller=Login&action=mainActionForm">
            <?php
        ...
        <div class="w-100 text-center">
            <a href="index.php?controller=Register&action=viewForm" class="btn btn-link fit-content">Create Account Admin</a>
        </div>
    </div>
</div>
